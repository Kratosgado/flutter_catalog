...
extension TodoItemQueryFilter
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> contentIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> contentIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> createdAtIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> createdAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'createdAt',
      ));
