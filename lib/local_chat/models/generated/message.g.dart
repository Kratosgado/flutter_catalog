...
extension MessageQueryFilter on QueryBuilder<Message, Message, QFilterCondition> {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> onlyEmojiIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> onlyEmojiIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'onlyEmoji',
      ));
...
extension MessageQuerySortBy on QueryBuilder<Message, Message, QSortBy> {
  ...
  QueryBuilder<Message, Message, QAfterSortBy> sortByOnlyEmoji() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'onlyEmoji', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> sortByOnlyEmojiDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'onlyEmoji', Sort.desc);
    });
  }
...
extension MessageQuerySortThenBy on QueryBuilder<Message, Message, QSortThenBy> {
  ...
  QueryBuilder<Message, Message, QAfterSortBy> thenByOnlyEmoji() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'onlyEmoji', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> thenByOnlyEmojiDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'onlyEmoji', Sort.desc);
    });
  }
...
extension MessageQueryWhereDistinct on QueryBuilder<Message, Message, QDistinct> {
  ...
  QueryBuilder<Message, Message, QDistinct> distinctByOnlyEmoji() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'onlyEmoji');
    });
  }
...
extension MessageQueryProperty on QueryBuilder<Message, Message, QQueryProperty> {
  ...
  QueryBuilder<Message, bool?, QQueryOperations> onlyEmojiProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'onlyEmoji');
    });
  }

  QueryBuilder<Message, int?, QQueryOperations> senderIdProperty() {
    return QueryBuilder.apply(this, (query) {
